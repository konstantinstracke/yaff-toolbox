...
if len(sys.argv) != 2:
    prog = sys.argv[0]
    print(f"Usage: python {prog} init.xyz")
    print("Converts a Yaff .xyz file to a .cif file.\n Needs rvecs hardcoded.")
    sys.exit(1)

fn_xyz = sys.argv[1]
outfile_name = fn_xyz.split('.')[0]
bohr_to_angstrom = 0.52917721067
angstrom_to_bohr = 1.0 / bohr_to_angstrom

# rvecss =  np.array([[32.950566, -0.88532527,  1.02996501],
#                         [ 0.53300045, 19.964102,  0.22727987],
#                         [-0.84084716, -0.29897316, 21.114567]])

rvecss = np.array([[16.795051, -0.271870, 0.000915],
  [-0.110345, 26.686888, -0.022736],
  [ 0.108848, -0.124444, 11.617653]])*angstrom_to_bohr


system = System.from_file(fn_xyz, rvecs=rvecss)
dump_cif(system, outfile_name + '.cif', ffatypes=None)
